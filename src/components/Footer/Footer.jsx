  ...
  return (
    <footer className="bg-gray-900 py-6 w-full">
      <div className="container mx-auto px-4 py-2 text-center text-white drop-shadow-lg">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 font-serif gap-8">
      ...
      <div className="mt-4 bg-gray-900">
        <div className="container mx-auto px-4 py-2 text-center text-white drop-shadow-lg">
          <p className='text-slate-100 font-medium text-md font-serif'>&copy; {new Date().getFullYear()} Shihab. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
