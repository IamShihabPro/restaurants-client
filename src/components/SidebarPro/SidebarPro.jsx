...
const SidebarPro = () => {
    ...
    return (
        <div>
             <div>
             <div className='flex justify-between items-center py-6 px-8 lg:py-0 lg:px-0 font-serif'>

                <div className='h-screen bg-gray-900 hidden sm:hidden md:hidden lg:block px-8'>
                ...
                <div className={`fixed h-full w-screen bg-white/50 lg:hidden backdrop-blur-sm top-0 right-0 ${isOpen ? 'flex' : 'hidden'}`}>
                    <div className={`text-black bg-red-500 flex flex-col absolute left-0 top-0 h-screen z-50 p-8 gap-8 w-56`}>
                     <IoClose onClick={() => setIsOpen(false)}  className='mt-0 mb-8 text-2xl cursor-pointer' />
                        ...
                        <Link className='font-bold'> All Foods </Link>
